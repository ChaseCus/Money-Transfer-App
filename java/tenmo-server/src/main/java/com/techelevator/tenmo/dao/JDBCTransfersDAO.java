...
public class JDBCTransfersDAO implements TransfersDAO {
	...
	//Getting all transfers with User ID input using Join statements, Did not use left_join because Do not want nulls.
	@Override
	...
	//Get specific transfer by inputing transfer ID using Join, did not want nulls
	@Override
	...
	//Send transfer with 3 parameters, userFrom, userTo, and the amount sent.
	//comparing bigdecmial to make sure not sending negative or more than balance
	@Override
...
//		}
//	}
	//maprow for Transfer information
